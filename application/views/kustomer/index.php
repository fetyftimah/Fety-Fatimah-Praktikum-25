                        ...
                        <tbody>
                            ...
                            foreach ($kustomer as $kustomer) {
                                echo "<tr>
                                        ...
                                        <td>$kustomer->telp</td>
                                        <td>
                                            <a href='".base_url('kustomer/getedit/' . $kustomer->id)."' class='btn btn-sm btn-info'>
                                                <i class='fas fa-edit'></i> Edit
                                            </a>
                                            <a href='".base_url('kustomer/delete/' . $kustomer->id)."' class='btn btn-sm btn-danger' onclick='return confirm(\"Ingin menghapus data ini?\");'>
