                 ...
                 <div class="card mb-4">
                    <div class="card-body">
                        <form class="form-horizontal" method="post" action="<?php echo base_url('report/kustomerkustom')?>" target="_blank">
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Costum Ekternal file Controller : Menyertakan report pada file berbeda dan diletakan di folder view berdasarkan fungsi</label>
                            </div>
                            <button type="submit" class="btn btn-warning">Cetak Laporan</button>
                        </form>
                    </div>
