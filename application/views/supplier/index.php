                        ...
                        <tbody>
                            ...
                            foreach ($supplier as $supplier) {
                                echo "<tr>
                                        ...
                                        <td>
                                            <a href='".base_url('supplier/getedit/' . $supplier->id)."' class='btn btn-sm btn-info'>
                                                <i class='fas fa-edit'></i> Edit
                                            </a>
                                            <a href='".base_url('supplier/delete/' . $supplier->id)."' class='btn btn-sm btn-danger' onclick='return confirm(\"Ingin menghapus data ini?\");'>
